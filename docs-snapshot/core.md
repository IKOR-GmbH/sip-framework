...
Default implementation of the healthcheck will issue a GET request to the endpoint URL. If the endpoint returns 
_405 (Method not allowed)_ status code, it will still be considered as a healthy endpoint.

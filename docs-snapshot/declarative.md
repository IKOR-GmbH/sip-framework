...
SIP Framework allows custom code to be added to multiple predefine points in the adapter that can control the behaviour of the specific declarative element. 

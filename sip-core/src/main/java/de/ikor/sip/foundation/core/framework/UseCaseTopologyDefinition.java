...
public class UseCaseTopologyDefinition {
  ...
  public UseCaseTopologyDefinition to(OutConnector... outConnectors) throws Exception {
    ...
    multicastDefinition = appendParallelProcessingIfMultipleConnectors(multicastDefinition, outConnectors);
  ...
  private void generateTestRoutes(OutConnector... outConnectors) {
    ...
    testingDefinition = appendParallelProcessingIfMultipleConnectors(testingDefinition, outConnectors);
  ...
  private MulticastDefinition appendParallelProcessingIfMultipleConnectors(MulticastDefinition multicastDefinition, OutConnector[] outConnectors) {
  ...
  private MulticastDefinition initMulticastRoute(RouteBuilder routeBuilder, MulticastDefinition multicastDefinition, boolean isTest) {
    ...
    return multicastDefinition == null
        ? routeBuilder.from(uri).multicast()
        : multicastDefinition;
  }

...
import static de.ikor.sip.testkit.workflow.thenphase.result.ValidationType.FULL;
import static java.util.stream.Collectors.toList;

import de.ikor.sip.testkit.configurationproperties.TestCaseBatchDefinition;
...
import de.ikor.sip.testkit.exception.handler.ExceptionLogger;
import de.ikor.sip.testkit.workflow.TestCase;
import de.ikor.sip.testkit.workflow.givenphase.Mock;
import de.ikor.sip.testkit.workflow.givenphase.MockFactory;
import de.ikor.sip.testkit.workflow.thenphase.result.ValidationType;
import de.ikor.sip.testkit.workflow.thenphase.validator.TestValidatorFactory;
import de.ikor.sip.testkit.workflow.whenphase.ExecutionWrapper;

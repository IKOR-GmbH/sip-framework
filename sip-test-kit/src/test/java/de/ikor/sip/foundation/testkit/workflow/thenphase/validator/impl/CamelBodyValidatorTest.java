...
class CamelBodyValidatorTest {
  ...
  @ParameterizedTest
  @ValueSource(strings = {EMPTY, "some value", "null"})
  void When_expectedBodyHasEmptyStringAsValue_Then_validatorIsApplicableForAnyValueOfActual(
      String actualValue) {
  ...
  @ParameterizedTest
  @ValueSource(strings = {EMPTY, "some value", "null"})
  void When_expectedBodyIsNull_Then_validatorIsNotApplicableForAnyValueOfActual(
      String actualValue) {
